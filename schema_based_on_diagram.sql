...
CREATE INDEX medical_history_id_asc ON medical_histories_has_treatments(medical_history_id ASC);
CREATE INDEX treatment_id_asc ON medical_histories_has_treatments(treatment_id ASC);
